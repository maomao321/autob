        ...
        try:
            ...
            experiences.append(
                TradeExperience(
                    ...
                    entry_price=_decimal_text(entry_price, places=2),
                    exit_price=_decimal_text(exit_price, places=2),
                    entry_fee=_decimal_text(entry_fee, places=2),
                    exit_fee=_decimal_text(exit_fee, places=2),
                    gross_pnl=_decimal_text(gross_pnl, places=2),
                    net_pnl=_decimal_text(net_pnl, places=2),
    ...
    for group_id, group_bars in sorted(groups.items()):
        ...
        result.append(
            TradeExperience(
                ...
                quantity="",
                entry_price=_decimal_text(selected[0].close, places=2),
                exit_price=_decimal_text(selected[-1].close, places=2),
                entry_fee="",
                exit_fee="",
                gross_pnl="",
                net_pnl="",
